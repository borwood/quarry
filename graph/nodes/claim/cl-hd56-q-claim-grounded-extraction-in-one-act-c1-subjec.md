...
id: cl-hd56
type: claim
title: '`q-claim`: grounded extraction in one act — C1 subjects, C2 grounding, derived provenance, vein titles ride --title'
v: 5
status: asserted
...
kind: vein
aliases:
- q-claim-grounded-extraction-in-one-act-c1-subjec
edges:
- rel: about
  to: ar-c7f5
  at: 1
